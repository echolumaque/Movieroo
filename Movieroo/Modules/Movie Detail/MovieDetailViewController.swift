...
protocol MovieDetailView: AnyObject {
    ...
    func updateMovieDetail(_ result: Result<MovieDetail, NetworkingError>)
    func updateMovieReview(_ result: Result<MovieReview, NetworkingError>)
    func updateMovieCertification(_ result: Result<MovieCertification, NetworkingError>)
}
...
class MovieDetailViewController: UIViewController, MovieDetailView {
    ...
    func configureMovieDetail() {
        view.addSubviews(posterImageView, movieTitle, movieSubtitles)
        ...
        movieTitle.font = UIFont.preferredFont(forTextStyle: .title1, compatibleWith: UITraitCollection(legibilityWeight: .bold))
        ...
        // MARK: - Rating divider
        let ratingDivider = Divider()
        
        // MARK: - Rating label
        let ratingLabel = UILabel()
        ratingLabel.translatesAutoresizingMaskIntoConstraints = false
        ratingLabel.textColor = .secondaryLabel
        ratingLabel.font = UIFont.preferredFont(forTextStyle: .title3, compatibleWith: UITraitCollection(legibilityWeight: .bold))
        ...
        starRatingModel.rating = 3.56
        
        // MARK: - Number of votes
        numberOfVotesLabel.translatesAutoresizingMaskIntoConstraints = false
        numberOfVotesLabel.textColor = .secondaryLabel
        numberOfVotesLabel.font = UIFont.preferredFont(forTextStyle: .title3, compatibleWith: UITraitCollection(legibilityWeight: .bold))
        numberOfVotesLabel.text = "(1,000)"
        
        view.addSubviews(overviewDivider, overview, ratingDivider, ratingLabel, hostedStarsView.view, numberOfVotesLabel)
        NSLayoutConstraint.activate([
            ...
            movieTitle.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: horizontalPadding),
            
            // MARK: - Subtitle
            movieSubtitles.topAnchor.constraint(equalTo: movieTitle.bottomAnchor, constant: verticalPadding),
            movieSubtitles.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: horizontalPadding),
            
            // MARK: - Divider
            overviewDivider.topAnchor.constraint(equalTo: movieSubtitles.bottomAnchor, constant: verticalPadding),
            overviewDivider.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: horizontalPadding),
            overviewDivider.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -horizontalPadding),
            ...
            overview.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: horizontalPadding),
            overview.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -horizontalPadding),
            
            // MARK: - Rating divider
            ratingDivider.topAnchor.constraint(equalTo: overview.bottomAnchor, constant: verticalPadding),
            ratingDivider.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: horizontalPadding),
            ratingDivider.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -horizontalPadding),
            ratingDivider.heightAnchor.constraint(equalToConstant: 1),
            
            // MARK: - Rating label
            ratingLabel.topAnchor.constraint(equalTo: ratingDivider.bottomAnchor, constant: verticalPadding),
            ratingLabel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: horizontalPadding),
            ratingLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -horizontalPadding),
            
            // MARK: - Rating count
            numberOfVotesLabel.topAnchor.constraint(equalTo: ratingDivider.bottomAnchor, constant: verticalPadding),
            numberOfVotesLabel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -horizontalPadding),
            numberOfVotesLabel.heightAnchor.constraint(equalToConstant: 20),
            
            // MARK: - Stars
            hostedStarsView.view.topAnchor.constraint(equalTo: ratingDivider.bottomAnchor, constant: verticalPadding),
            hostedStarsView.view.trailingAnchor.constraint(equalTo: numberOfVotesLabel.leadingAnchor, constant: -4),
            hostedStarsView.view.heightAnchor.constraint(equalToConstant: 20)
        ])
    }
    ...
    private func getMovieDetailAndReview() {
        ...
        Task {
            try? await presenter.fetchMovieDetail(for: movieId)
            try? await presenter.fetchMovieReview(for: movieId)
            try? await presenter.fetchMovieCertification(for: movieId)
        }
    }
...
//            
//            let genres = movieDetail.genres.map { $0.name }.joined(separator: ", ")
//            movieSubtitles.text = "\(genres) • \(movieDetail.runtime.timeString)"
